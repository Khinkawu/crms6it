                ...
                headers: [
                    ...
                    // CSP — allows Next.js/Firebase/LINE while blocking framing from unknown origins
                    {
                        ...
                        value: [
                            ...
                            "img-src * data: blob:",
                            "connect-src 'self' *.googleapis.com *.firebaseio.com wss://*.firebaseio.com firebasestorage.googleapis.com *.firebaseapp.com *.cloudfunctions.net *.google.com *.line.me *.line-scdn.net",
