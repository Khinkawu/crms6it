...
import { useRepairAdmin } from "@/hooks/useRepairAdmin";
import RepairActionsBar from "@/components/admin/RepairActionsBar";
import { RepairTicketCard, RepairTicketList } from "@/components/repair/RepairTicketCard";
...
const LazyRepairModal = dynamic(
    () => import("@/components/repair/RepairModal"),
    { loading: () => null, ssr: false }
);

export default function ITRepairsView() {
