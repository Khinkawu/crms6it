...
export default function RepairLiffPage() {
    ...
    if (!isLoggedIn || !profile) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gray-50">
                ...
                <p className="text-gray-500">Loading Repair System...</p>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col items-center p-8">
            <h1 className="text-2xl font-bold text-gray-800 mb-6">Repair System</h1>

            <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 flex flex-col items-center text-center shadow-sm w-full max-w-sm">
            ...
            <div className="mt-8 text-center text-gray-500 text-sm">
                <p>Ready to submit repair tickets.</p>
            </div>
        </div>
    );
}
