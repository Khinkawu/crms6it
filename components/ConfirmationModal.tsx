            ...
            <div className="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-3xl shadow-2xl max-w-sm w-full p-6 animate-scale-in overflow-hidden">
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        className={`flex-1 py-3 rounded-xl text-white font-bold transition-all active:scale-[0.98] text-sm ${isDangerous
                                ? 'bg-red-500 hover:bg-red-600'
                                : 'bg-gray-900 dark:bg-white dark:text-gray-900 hover:bg-gray-700 dark:hover:bg-gray-100'
                            }`}
                    >
                        {confirmText}
                    </button>
