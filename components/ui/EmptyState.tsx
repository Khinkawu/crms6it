        ...
        <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
            ...
            {action && (
                <button
                    ...
                    className="px-6 py-2.5 rounded-xl bg-gray-900 dark:bg-white text-white dark:text-gray-900 font-bold hover:bg-gray-700 dark:hover:bg-gray-100 transition-all"
                >
                    {action.label}
                </button>
            )}
