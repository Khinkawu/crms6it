...
export default function CommandPalette({ isOpen, onClose }: CommandPaletteProps) {
    ...
    const allCommands: CommandItem[] = [
        ...
        { id: "admin-photography", name: "งานตากล้อง", description: "จัดการงานตากล้องและประมวลภาพ", icon: Camera, path: "/admin/photography", category: "Admin", keywords: ["photo", "ตากล้อง", "camera"], roles: ["admin"] },
