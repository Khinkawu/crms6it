...
export default function CommandPalette({ isOpen, onClose }: CommandPaletteProps) {
    ...
    const allCommands: CommandItem[] = [
        ...
        // Admin
        { id: "admin-dashboard", name: "Command Center", description: "Admin Dashboard Overview", icon: LayoutDashboard, path: "/manage/dashboard", category: "Admin", keywords: ["dashboard", "admin", "overview"], roles: ["admin"] },
        { id: "admin-repairs", name: "จัดการงานซ่อม", description: "ดูและจัดการงานซ่อมทั้งหมด (โสตฯ/อาคาร)", icon: ClipboardList, path: "/manage/repairs", category: "Admin", keywords: ["manage", "repairs", "จัดการ", "ซ่อม"], roles: ["admin", "moderator", "technician", "facility_technician"] },
        { id: "admin-bookings", name: "จัดการการจอง", description: "อนุมัติและจัดการการจอง", icon: Calendar, path: "/manage/bookings", category: "Admin", keywords: ["manage", "bookings"], roles: ["admin", "moderator"] },
        { id: "admin-photography", name: "งานตากล้อง", description: "จัดการงานตากล้องและประมวลภาพ", icon: Camera, path: "/manage/photography", category: "Admin", keywords: ["photo", "ตากล้อง", "camera"], roles: ["admin", "atlas"] },
        { id: "admin-inventory", name: "จัดการคลังอุปกรณ์", description: "จัดการอุปกรณ์และครุภัณฑ์ (โสตฯ/อาคาร)", icon: Package, path: "/manage/inventory", category: "Admin", keywords: ["inventory", "stock", "อุปกรณ์", "คลัง"], roles: ["admin", "technician", "facility_technician"], allowPhotographer: true },
