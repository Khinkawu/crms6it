...
export default function CommandPalette({ isOpen, onClose }: CommandPaletteProps) {
    ...
    const allCommands: CommandItem[] = [
        ...
        // Admin
        { id: "admin-dashboard", name: "Command Center", description: "Admin Dashboard Overview", icon: LayoutDashboard, path: "/admin/dashboard", category: "Admin", keywords: ["dashboard", "admin", "overview"], roles: ["admin"] },
        { id: "admin-repairs", name: "จัดการงานซ่อม", description: "ดูและจัดการงานซ่อมทั้งหมด (โสตฯ/อาคาร)", icon: ClipboardList, path: "/admin/repairs", category: "Admin", keywords: ["manage", "repairs", "จัดการ", "ซ่อม"], roles: ["admin", "moderator", "technician", "facility_technician"] },
        ...
        { id: "admin-photography", name: "งานตากล้อง", description: "จัดการงานตากล้องและประมวลภาพ", icon: Camera, path: "/admin/photography", category: "Admin", keywords: ["photo", "ตากล้อง", "camera"], roles: ["admin", "atlas"] },
        { id: "admin-inventory", name: "จัดการคลังอุปกรณ์", description: "จัดการอุปกรณ์และครุภัณฑ์ (โสตฯ/อาคาร)", icon: Package, path: "/admin/inventory", category: "Admin", keywords: ["inventory", "stock", "อุปกรณ์", "คลัง"], roles: ["admin", "technician", "facility_technician"], allowPhotographer: true },
