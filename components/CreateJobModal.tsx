                ...
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
                        <motion.div
                            ...
                            className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] pointer-events-auto"
                        >
                            {/* Header */}
                            ...
                            <div className="p-4 border-t border-gray-200 dark:border-gray-700 flex-shrink-0">
                                <button
                                    ...
                                    className="w-full py-3 rounded-xl bg-gray-900 dark:bg-white text-white dark:text-gray-900 font-medium disabled:opacity-50 hover:bg-gray-700 dark:hover:bg-gray-100 transition-all"
                                >
